        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            ...
            <div className="mt-12 grid grid-cols-3 gap-4">
              {[{ icon: <Shield size={24} />, label: 'Cyber Security', color: 'text-primary-blue' }, { icon: <Bug size={24} />, label: 'Bug Hunting', color: 'text-secondary-green' }, { icon: <Lock size={24} />, label: 'AI Security', color: 'text-accent-purple' }].map((item, index) => (
                <motion.div
                  key={index}
